...
export const SinglePageLoader: React.FC<IContentLoaderProps> = (props) => {
  return (
    <ContentLoader
      height={1000}
      width={800}
...
export const PostPlaceholder: React.FC<IContentLoaderProps> = (props) => {
  return (
    <ContentLoader
      height={400}
      width={400}
...
export const ProfilePicLoader: React.FC = () => (
  <ContentLoader
    height={180}
    width={180}
    speed={3}
...
export const ImageCardLoader: React.FC = () => (
  <ContentLoader
    height={270}
    width={215}
    speed={2}
