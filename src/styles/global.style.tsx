...
const GlobalStyle = createGlobalStyle`
  * {
  ...
  ::selection {
    background: ${themeGet("primary.0", "#4dcad2")};
    ...
    .ant-select-dropdown-menu {
      .ant-select-dropdown-menu-item {
        ...
        &.ant-select-dropdown-menu-item-active {
          background-color: rgba(21, 90, 147, 0.1);
        }
      }
    }
  }
  ...
  .quantity {
    button.btn {
      border: 1px solid ${themeGet("primary.0", "#4dcad2")};
      svg {
  ...
  .ant-checkbox-checked::after {
    border-color: ${themeGet("primary.0", "#4dcad2")} !important;
  }

  .ant-select-item-option-selected:not(.ant-select-item-option-disabled) {
    background-color: rgba(21, 90, 147, 0.2);
  }
  ...
  .ant-radio-group-solid .ant-radio-button-wrapper-checked:not(.ant-radio-button-wrapper-disabled):hover {
    opacity: 0.9;
    border-color: ${themeGet("primary.0", "#4dcad2")} !important;
    background: ${themeGet("primary.0", "#4dcad2")} !important;
  }
`;
