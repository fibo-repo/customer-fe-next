...
export const OnboardingWrapperUpdate = styled.div`
  width: 50%;
  padding: 81px 41px;
  @media (min-width: 1441px) {
    padding: 41px 65px;
...
export const FormWrapper = styled.div`
  ...
  .signin-btn {
    ...
    background-color: ${themeGet("primary.0", "#4dcad2")} !important;
...
export const Title44 = styled.h2`
  color: ${themeGet("text.0", "#2C2C2C")};
  font-size: 44px;
  line-height: 54px;
  font-weight: 700;
...
export const BannerWrapperUpdate = styled.div`
  width: 50%;
  height: 100%;
  position: fixed;
  color: red;
